...
<head>
    <meta charset="UTF-8">
    <title>Chapchap Pay - Join & Loans</title>
...
<body>
    ...
    <header>
        ...
        <p align="center">Apply for Membership or Loans</p>
    ...
    <main>
        ...
        <form action="process.php" method="POST">
            ...
            <fieldset>
                ...
                <p>
                    <input type="radio" id="loanOption" name="requestType" value="loan">
                    <label for="loanOption">Chama Emergency Loan Request</label>
                </p>
                <p>
                    <label for="loanAmount">Loan Amount Needed (if applicable - KES):</label><br>
                    <input type="number" id="loanAmount" name="loanAmount" placeholder="e.g. 5000">
                </p>
            </fieldset>
