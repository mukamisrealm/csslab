...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // -----------------------------------------------------
    // 1. WELCOME MESSAGE (Prompts Once Per Session on Home)
    // -----------------------------------------------------
    ...
    if (isHomePage) {
        let userName = sessionStorage.getItem("chappay_user_name");

        if (!userName) {
            userName = prompt("Welcome to ChapPay! Please enter your name:");
            if (userName && userName.trim() !== "") {
                userName = userName.trim();
                sessionStorage.setItem("chappay_user_name", userName);
            }
        }
        ...
        if (userName) {
            ...
            welcomeContainer.innerHTML = `👋 Karibu, <span>${userName}</span>! Welcome to your Chama dashboard.`;
        }
    }
    ...
    if (form) {
        form.addEventListener("submit", function (event) {
            ...
            if (!isValid) {
                event.preventDefault(); // Stop submission to process.php if invalid
    ...
    // -----------------------------------------------------
    // 3. DYNAMIC CONTENT (Dark/Light Theme & Details Toggle)
    // -----------------------------------------------------
